...
const list = ref([]);
const warning = ref([]);
const serverWarnings = computed(() => warning.value.filter((x) => x.warning_type === 'server'));
const maintenanceWarnings = computed(() => warning.value.filter((x) => x.warning_type === 'maintenance'));
